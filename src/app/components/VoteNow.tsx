...
export default function VoteNow({ department_org }: { department_org?: string }) {
  ...
  // Show the already voted message at the top if hasVoted is true
  let alreadyVotedMessage = null;
  if (hasVoted && elections.length > 0) {
    if (elections[0].is_uni_level) {
      alreadyVotedMessage = (
      ...
      alreadyVotedMessage = (
        <div className="bg-green-50 border border-green-300 rounded-lg p-6 text-center m-8">
